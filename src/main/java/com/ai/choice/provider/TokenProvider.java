package com.ai.choice.provider;
...
public class TokenProvider {
    private static final String GET_CHOICEAI_LLC = "GET_CHOICEAI_LLC";
    ...
    public String createAccessToken(UserPrincipal userPrincipal) {
        return JWT.create().withIssuer(GET_CHOICEAI_LLC).withAudience(CUSTOMER_MANAGEMENT_SERVICE)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(GET_CHOICEAI_LLC).build();
